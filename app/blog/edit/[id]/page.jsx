...
const EditBlog = ({params}) => {
        ...
        async function fetchBlog() {
            try {
                ...
                if(res.status === 200) {
                    ...
                    setError('Error fething blog data')
                }
    ...
    const handleSubmit = async(e) => {
        ...
        if(title.length < 4) {
            setError('Title must be at least 4 character long.')
            return;
        }

        if(description.length < 10) {
            setError('Description must be at least 10 character long.')
            return;
        }
                ...
                <div>
                    ...
                    {state.newImage ? (
                        <div>
                            ...
                            <button onClick={handleCancelUploadImage}>Cancel</button>
                        </div>
                    ) : (
                        <div>
